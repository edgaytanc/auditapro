...
def aside_navbar_processor(req: HttpRequest):
    ...
    nav_bar_links: List[NavBarLink] = [
        ...
        },
        {
            ...
            "collapse_values": [
                {
                    "active": get_is_active_route("audit_time_summary_index", req),
                    "name": "Resumen de Tiempo de Auditoría",
                    "type": "anchor",
                    "url": "audit_time_summary_index",
                },
                {
                    "active": get_is_active_route("audit_marks", req),
                    "name": "Marcas de Auditoría",
                    "type": "anchor",
                    "url": "audit_marks",
                },
                {
                    "active": get_is_active_route("currency_types", req),
                    "name": "Tipos de Moneda",
                    "type": "anchor",
                    "url": "currency_types",
                },
                {
                    "active": get_is_active_route("activities_page", req),
                    "name": "Actividades",
                    "type": "anchor",
                    "url": "activities_page",
                },
